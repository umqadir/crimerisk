...
def build_final_report(
    *,
    ...
    def summarize_year(df: pd.DataFrame, year: int, pop_col: str, models: dict[str, Any] | None) -> dict[str, Any]:
        ...
        idx_stats["total"] = _describe_index(df, index_col="index_event_burden_resident", pop_col=pop_col)
        ...
        outliers = view.sort_values("index_event_burden_resident", ascending=False).head(20)[cols].copy()
